module github.com/jaie/claude-otel-collector/components/enrichmentprocessor

go 1.23.0

require (
	github.com/jaie/claude-otel-collector/components/enrichmentctlextension v0.0.0-00010101000000-000000000000
...
replace github.com/jaie/claude-otel-collector/components/enrichmentctlextension => ../enrichmentctlextension
