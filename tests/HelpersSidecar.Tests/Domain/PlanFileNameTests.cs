...
/// <summary>BR-EXTEND-004 — plan filename parsing and rendering.</summary>
public class PlanFileNameTests
{
    ...
    {
        var p = PlanFileName.TryParse("The-OTEL-Plan.md");
        Assert.NotNull(p);
    ...
    {
        var p = PlanFileName.TryParse(fileName);
        Assert.NotNull(p);
